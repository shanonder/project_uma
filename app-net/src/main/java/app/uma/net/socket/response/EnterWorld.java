 ...
 */
public class EnterWorld  extends ServerResponse{
	public EnterWorld(int status , RoleData role, ArrayList<]PackData> packs, ArrayList<]Short> modules, String customize) throws Exception{
